...
namespace Prepaid.Repositories
{
    public interface IBillRespository : IRepository<int, Bill>
    {
        ...
        IEnumerable<RoomBill> GetRoomPagerBills<T>(string roomNo, string buildingNo, string realName, string startTime, string endTime,
        ...
        IEnumerable<PrepaidBill> GetPrepaidPagerBills<T>(string roomNo, string buildingNo, string realName,
